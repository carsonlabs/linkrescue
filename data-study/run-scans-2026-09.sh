...
OUT_DIR="/c/DEV/linkrescue/data-study/results-2026-09"
LOG="/c/DEV/linkrescue/data-study/scan-log-2026-09.txt"

echo "=== LinkRescue 50-site re-run (corrected classifier) started at $(date) ===" > "$LOG"
count=0
